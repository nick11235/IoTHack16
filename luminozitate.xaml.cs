...
namespace testapp2
{
    ...
    /// </summary>
    public sealed partial class luminozitate : Page
    {
        
        private readonly Task deviceClient;
        ...
        public float getLuminozitate()
        {
            ...
            intensitate = randomNumber;
            return randomNumber;

        }

        public async void lumina()
        {
            int intensitate = 3;
            this.InitializeComponent();
            await AzureIoTHub.SendDeviceToCloudMessageAsync(intensitate.ToString());
